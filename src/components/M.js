...
function MechanicsProject() {
  return (
//     <div className="project-container">
//       <h2>Introduction to Quantum Mechanics</h2>
//       <div className="project-info">
//         <p>mechanics is a fundamental theory in physics that describes the behavior of matter and energy at the atomic and subatomic scale. It's a fascinating field that has many implications for technology and our understanding of the universe.</p>
...
export default MechanicsProject;